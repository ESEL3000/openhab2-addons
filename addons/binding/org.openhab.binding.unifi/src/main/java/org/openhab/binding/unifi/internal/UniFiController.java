...
public class UniFiController {
    ...
    public UniFiController(UniFiControllerConfig config) throws UniFiException {
        ...
        // FIXME mgb: the controller host + port could be invalid but user + password valid
        // FIXME mgb: the user/pass could change after configuration
    }
    ...
    public synchronized boolean isWirelessClientOnline(UniFiWirelessClient client) {
